...
export default function MetaData({ title, description, keywords, image, type, date, ...customMeta }: MetaDataProps) {
  ...
  const meta = {
    title: title || "Sunwing Vacations group",
    description: description || "Sunwing Vacations group | sunwingvacationsgroup.com",
		keywords: keywords || "private jet rental, charter flights, luxury travel, air charter services, private plane, business jet, personal jet",
